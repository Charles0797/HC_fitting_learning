...
class HysteresisEnv:
    ...
    def __init__(self):
        # 两个可调参数的取值范围
        self.param_ranges = [[1, 1000], [1, 200000]]
        # 从 Excel 文件中读取数据
    ...
    def hysteretic_curve(self, params):
        ...
        ops.uniaxialMaterial("Steel02", 1, params[0], params[1], 0.01, 15.0, 0.925, 0.15, 0.0, 1.0, 0.0, 1.0)
...
if __name__ == "__main__":
    ...
    print("Target parameters: 233, 123, 0.01")
